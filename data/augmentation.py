...
class AugmentationPipeline(nn.Module):
    ...
    def apply_train_augmentations(self, input):
        ...
        transformation = self.aff.transform_matrix
    ...
    def forward_transformed(
        ...
        segmentations_as_shapely_objects = (
            utils_cyws.geometry.get_segmentation_as_shapely_polygons_from_coco_annotations(annotations)
        )
        ############
        ## Step 1 ##
        ############
        ...
        image1_segmentations_transformed = (
            utils_cyws.geometry.apply_kornia_transformation_to_shapely_objects(
                segmentations_as_shapely_objects,
                image1_image_transformation,
                image_shape_as_hw,
                keep_empty=True,
        ...
        for image1, image2 in zip(
            ...
            intersection_segmentation = utils_cyws.geometry.make_valid_polygon(
        ...
        ## Step 4 ##
        ############
        target_image1_segmentations = utils_cyws.geometry.apply_kornia_transformation_to_shapely_objects(
            intersection_of_segmentations,
            image1_image_transformation,
            image_shape_as_hw,
            keep_empty=True,
        )
        target_image2_segmentations = utils_cyws.geometry.apply_kornia_transformation_to_shapely_objects(
            intersection_of_segmentations,
            image2_image_transformation,
            image_shape_as_hw,
            keep_empty=True,
        )
        transformed_image1_annotations = utils_cyws.geometry.merge_shapely_polygons_into_annotations(
            target_image1_segmentations, annotations
        )
        transformed_image2_annotations = utils_cyws.geometry.merge_shapely_polygons_into_annotations(
